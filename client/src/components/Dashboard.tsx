...
const Dashboard = () => {
  ...
  const handleLogout = async () => {
    // See AuthenticatedNavbar.tsx — signOut() ends the real session and the
    // onAuthStateChange listener in supabaseClient.ts clears the
    // compatibility localStorage keys for us.
