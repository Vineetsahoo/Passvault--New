...
const SignIn: React.FC = () => {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // supabaseClient.ts's onAuthStateChange listener writes accessToken /
      // isAuthenticated / userData to localStorage for us — no manual
      // localStorage calls needed here anymore.
