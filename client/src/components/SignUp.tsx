  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      const { data, error: signUpError } = await supabase.auth.signUp({
        ...
        options: {
          // handle_new_user() in the Postgres migration reads this to
      ...
      // data.session is null here and the user needs to click the email
      // link before they can sign in — send them to sign in with a notice
